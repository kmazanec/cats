...
| [VLN-2026-004](./VLN-2026-004-synthesize-refusal-compensation-disclosure.md) | High | Synthesizer volunteers out-of-baseline lab values when refusing a `default_briefing` trend request | **Open** — distinct from VLN-2026-003 (synthesize node, not supervisor); promoted by live Judge on production run `92e06667` |
